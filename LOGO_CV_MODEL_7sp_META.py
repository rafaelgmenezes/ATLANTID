...
os.chdir(r'C:\Users\alebi\Desktop\Tese Desktop LG\1- RESULTADOS TESE 031124 ASSOVIOS\7sp\Meta_features_7sp')#***>>>> UD
os.listdir()

Current_MW = pd.read_csv('META_FEATURES_7sp.csv')#***>>>> UD
...
#################
#%% Salvar ou carregar pkl - classificador

import dill
# os.chdir(r'C:\Users\alebi\Desktop\1- RESULTADOS TESE 031124\7sp\LOGO_META\A')
os.chdir(r'C:\Users\alebi\Desktop\FIGURES_SUB_PLOT_WHISTLE_ARTICLE')
os.listdir()

dill.dump_session('Classifier_whistle_LOGO_META_A.pkl')

# dill.load_session('Classifier_whistle_LOGO_META_A.pkl')

#%%    
#############################################################################
#%% DEFINIR DIRETORIO E CHECAR DADOS DA MASTER_WHISTLE DO CLASSIFICADOR

# os.chdir(r'C:\Users\alebi\Desktop\1- RESULTADOS TESE 031124\7sp\LOGO_META\A')# *********UD
# os.listdir()

# File_path = r'C:\Users\alebi\Desktop\1- RESULTADOS TESE 031124\7sp\LOGO_META\A'
